<template>
  <div class="bg-white p-4 rounded-xl shadow">
    ...
    <div v-if="sortedTasks.length" class="space-y-4">
      <div v-for="task in sortedTasks" :key="task.task_id" class="cursor-pointer border border-stone-200 rounded-lg p-4 flex justify-between items-start hover:bg-stone-50 transition">
        <div class="space-y-1">
